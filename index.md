...
- **Hong Liu**, Zhun Zhong, Nicu Sebe, Shin'ichi Satoh. [Mitigating Robust Overfitting via Self-Residual-Calibration Regularization](https://doi.org/10.1016/j.artint.2023.103877). IJCAI Journal Track, 2024. 
...
- Hao Zhang, Wenqi Shao, **Hong Liu**, Yongqiang Ma, Ping Luo, Yu Qiao, Kaipeng Zhang. [AVIBench: Towards Evaluating the Robustness of Large Vision-Language Model on Adversarial Visual-Instructions](https://arxiv.org/abs/2403.09346), arXiv, 2024.
- Yue Yang, Yuqi lin, **Hong Liu**, Wenqi Shao, Runjian Chen, Hailong Shang, Yu Wang, Yu Qiao, Kaipeng Zhang, Ping Luo. [Towards Implicit Prompt For Text-To-Image Models](https://arxiv.org/abs/2403.02118). ICML, 2024.
